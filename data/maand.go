...
func SetupMaand(tx *sql.Tx) error {
	tables := []string{
		...
		"CREATE TABLE IF NOT EXISTS job (job_id TEXT, name TEXT, version TEXT, min_memory_mb TEXT, max_memory_mb TEXT, current_memory_mb TEXT, min_cpu_mhz TEXT, max_cpu_mhz TEXT, current_cpu_mhz TEXT, update_parallel_count INT, PRIMARY KEY(name))",
