...
if __name__ == "__main__":
    ...
    if name == "agents":
        statement("SELECT agent_id, agent_ip, detained, (SELECT GROUP_CONCAT(label) FROM agent_labels al WHERE al.agent_id = a.agent_id ORDER BY label) as labels FROM agent a ORDER BY position", "no agents found")
