...
Use the same libraries as other events — see [job-command-api.md](../job-command-api.md):
...
- [job-command.md](job-command.md) — events and patterns · [job-command-api.md](../job-command-api.md) — runtime API
