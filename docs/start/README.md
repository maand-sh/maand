...
| 5 | [Jobs and lifecycle](./05-jobs-and-lifecycle.md) | `manifest.json`, Makefile, start/stop/restart, compose/systemd |
...
| 11 | [Health and monitoring](./11-health-and-monitoring.md) | Probes, Prometheus folder, pointers to logging docs |
...
| Maand command logs | [logging.md](../reference/observability/logging.md) |
