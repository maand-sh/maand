...
Prerequisites: [getting-started.md](./getting-started.md) · Deep dive: [job-command.md](../job-command.md)
...
Full reference: [jobs-and-dependencies.md](../jobs-and-dependencies.md#job-version) · deploy upgrade env: [deploy.md](../deploy.md#allocation-version-tracking)
...
Next: [day-2-operations.md](./day-2-operations.md) · [concepts.md](../concepts.md)
