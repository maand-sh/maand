...
Related: [configuration.md](./configuration.md) · [concepts.md](./concepts.md#allocation) · [build.md](./build.md#workspaceworkersjson)
...
- [build.md](./build.md#validateworkerresources) — build pipeline and validation step
- [concepts.md](./concepts.md#allocation) — how label matching creates allocations
- [kv.md](./kv.md) — `maand/job/<job>` and `vars/bucket/job/<job>` namespaces
